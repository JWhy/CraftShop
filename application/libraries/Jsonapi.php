...
class Jsonapi{
  ...
  public function __construct($params){
    $this->api = new JSONAPI_Connector($params);
  }
  
  public function getBalance($username){
    $req = $this->api->call("econ.getBalance", array($username));
...
class JSONAPI_Connector {
   ...
   *
   * @param string $method
   *          The name of the JSONAPI API method to generate the key for.
   ...
   *
   * @param string $method
   *          The name of the JSONAPI API method to generate the URL for.
   * @param array $args
   *          An array of arguments that are to be passed in the URL.
   ...
   *
   * @param array $methods
   *          An array of strings, where each string is the name of the JSONAPI API method to generate the URL for.
   * @param array $args
   *          An array of arrays, where each array contains the arguments that are to be passed in the URL.
   ...
   *
   * @param string $method
   *          The name of the JSONAPI API method to call.
   * @param array $args
   *          An array of arguments that are to be passed.
   ...
   *
   * @param array $methods
   *          An array strings, where each string is the name of a JSONAPI API method to call.
   * @param array $args
   *          An array of arrays of arguments that are to be passed.
